...
export default {
    signup: async (req: Request, res: Response, next: NextFunction) => {
        try {
            ...
            const userData = newUser.toObject() as unknown as { password?: string; userName: string; userEmail: string;[key: string]: unknown }
    ...
    signin: async (req: Request, res: Response, next: NextFunction) => {
        try {
            ...
            // Remove password field from user object
            const userWithoutPassword = user.toObject() as unknown as { password?: string; userName: string; userEmail: string;[key: string]: unknown }
    ...
    googleLogin: async (req: Request, res: Response, next: NextFunction) => {
        ...
        try {
            ...
            const clientList: string[] = [clientAndroid, clientIos]
    ...
    resetPassword: async (req: Request, res: Response, next: NextFunction) => {
        try {
            ...
            if (!user || !user.password || (await bcrypt.compare(newPassword, user.password))) {
