...
import { createGroupChallenge, deleteGroupChallenge, getGroupChallengeByJoinList, getGroupChallengeList, getGroupChallengeUserList, getJoinUserRateByPost, joinAndLeftGroupChallenge, updateGroupChallenge } from "../../controllers/community/groupChallenge.controller";
...
router.patch('/:groupId/challenge/:groupchallengeId', authMiddleware, upload.single("challengeImage"), validateRequest(updateGroupChallengeZodSchema), updateGroupChallenge);
